...
parser.add_argument('--lr', default=0.01, type=float, help='learning rate for classifier')
...
parser.add_argument('--alpha', type=float, default=0.125, help='step size alpha')
...
def train(epoch):
    ...
    with tqdm(total=(len(trainset) - len(trainset) % args.bs)) as _tqdm:
        ...
        for batch_idx, (inputs, targets) in enumerate(trainloader):
            ...
            loss = adv_cls_loss + 8 * (r_nr_loss + nr_rec_loss + r_rec_loss)
